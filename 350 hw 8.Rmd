...
```{r linewidth=80}
readLines("https://raw.githubusercontent.com/abbyglaser/36-350/master/README.md")
```
...
```{r linewidth=80}
#source_url("Enter the URL to the master branch version of dark_and_stormy.R here")
...
```
```
FILL ME IN (with line breaks for proper PDF output)
```
